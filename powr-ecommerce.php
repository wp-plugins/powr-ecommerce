<?php
    /**
     * @package POWr eCommerce
     * @version 1.4.007
     */
    /*
    Plugin Name: POWr eCommerce
    Plugin URI: http://www.powr.io
    Description: The simple way to sell products, downloads, and subscriptions.  Drop the widget anywhere in your theme. Or use the POWr icon in your WP text editor to add to a page or post. Edit on your live page by clicking the settings icon. More plugins and tutorials at POWr.io.
    Author: POWr.io
    Version: 1.4.007
    ...
    */
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////////Create eCommerce widget/////////////////////////////////
    class Powr_E_Commerce extends WP_Widget{
      //Create the widget
      public function __construct(){
        parent::__construct( 'powr_ecommerce',
                             __( 'POWr eCommerce' ),
                             array( 'description' => __( 'eCommerce by POWr.io') )
        );
      }
      //This prints the div
      public function widget( $args, $instance ){
        ...
        ?>
        <div class='widget powr-ecommerce' label='<?php echo $label; ?>'></div>
        <?php
      }
      ...
      public function form( $instance ){
        ?>
        <p>
          No need to edit here - just click the gears icon on your eCommerce.
        </p>
        <p>
    ...
    function register_powr_ecommerce() {
      register_widget( 'Powr_E_Commerce' );
    }
    //Use widgets_init action hook to execute custom function
    add_action( 'widgets_init', 'register_powr_ecommerce' );
    //Create short codes for adding plugins anywhere:
    function powr_ecommerce_shortcode( $atts ){
      if(isset($atts['label'])){
        $label = $atts['label'];
      }else{
        $label = '';
      }
      return "<div class='powr-ecommerce' label='$label'></div>";
    }
    add_shortcode( 'powr-ecommerce', 'powr_ecommerce_shortcode' );
